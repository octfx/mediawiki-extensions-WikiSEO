...
class InfoActionTest extends MediaWikiIntegrationTestCase
{
    ...
    public function testOnInfoAction()
    {
        ...
        $mediaTransformMock = $this->getMockBuilder(\MediaTransformOutput::class)->disableOriginalConstructor()->getMock();
        ...
        $fileMock->expects($this->once())->method('transform')->with(['width' => 200])->willReturn($mediaTransformMock);
